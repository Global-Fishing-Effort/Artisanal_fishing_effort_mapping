---
title: "Prep historical environmental data to 0.5 degrees"
...
# Summary 
Prep historical SST, CHL, and wind data for 0.5 degrees from ISIMIP climate projections
...
source(here::here("prep/04_prep_model_layers/_functions_data_wrangling_erddap.R"))
source(here("R/dir.R"))
...
CHL now: 
 ...
 - ERRDAP data is surface chlorophyll-a (mg/m3). The ISIMIP data is also chlorophyll-a
...
hist_files_sd <- list.files(file.path(rdsi_raw_dir, "ISIMIP/wind/"), pattern = "bias_corrected_0.5", full.names = TRUE)[9:16]
  ...
  wind_data <-   qs::qread(here("data/int/prediction_historical_data/half_degree/wind_yearly_1950_2014.qs"))
