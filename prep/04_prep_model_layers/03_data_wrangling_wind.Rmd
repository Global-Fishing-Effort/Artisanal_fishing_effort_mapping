...
qs::qsave(wind_data_imputed, here("data/model_features/wind_data.qs")) # only ~30 MB - cool 

```


# Spatially and temporally aggregated data to 1 by 1 degree cells if needed
