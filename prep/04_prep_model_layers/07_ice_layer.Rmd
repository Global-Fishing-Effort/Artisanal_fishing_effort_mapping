...
The regression slope in Kawaguchi et al.  is per unit `I` for the whole 1.25 × *10^6* km² region. To apply this relationship at the scale of an individual grid cell (e.g., 0.5°), we normalized `I` by the region’s area to express the relationship in terms of the **average number of iced months per location in the region**:
...
- Uses the same 15% ice concentration threshold as Hewitt (1997) and Kawaguchi (2009) for consistency.
