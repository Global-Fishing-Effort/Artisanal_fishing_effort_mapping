...
if(!file.exists(glue(file.path(rdsi_dir, "prep/random_forest/artisanal_skylight_sentinel/stage_2_models/pruning/stage_2_rf_train_{flag}_25.qs")))){
tic()
  model <- ranger(
  formula = full_model_formula,
  data = train,
...
toc() 
  ...
  model <- qs::qread(glue(file.path(rdsi_dir, "prep/random_forest/artisanal_skylight_sentinel/stage_2_models/pruning/stage_2_rf_train_{flag}_25.qs")))
