...
We use the data compiled in the previous scripts to fit a random forest regression model to predict the proportion of fishing vessels occurring in cells. 
