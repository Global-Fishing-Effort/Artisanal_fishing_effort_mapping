...
foreach(flag = flags, .packages = c("dplyr", "tidyr", "randomForest", "qs", "glue", "tictoc", "ranger", "PRROC")) %dopar% {
  ...
  if(!file.exists((glue(file.path(rdsi_dir, "prep/random_forest/artisanal_skylight_sentinel/stage_1_models/pruning/stage_1_rf_train_{flag}_25.qs"))))){
  ...
  case.weights = train$looks
    ...
    model <- qs::qread(glue(file.path(rdsi_dir, "prep/random_forest/artisanal_skylight_sentinel/stage_1_models/pruning/stage_1_rf_train_{flag}_25.qs")))
}
