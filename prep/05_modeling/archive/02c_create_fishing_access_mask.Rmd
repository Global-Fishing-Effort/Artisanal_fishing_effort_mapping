...
Here we create a dataset that described for each flag country, the EEZs they are able to fish in for each year. For artisanal data, we assume that countries can only fish in their EEZ, so this might be redundant.
