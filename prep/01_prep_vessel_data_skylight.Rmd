...
Vessel IDs:
 - Are they unique across the batches? For example, is vessel id 0 the same in batch 1 as in batch 3? 
   ...
   - Ok so they aren't unique across batches. Are they unique across images?? From Skylight's response it doesn't seem like it. "The idx column in vessel.csv is not unique between files". But then what do the idx tell us?? Are they only unique within the image pulls? Yes. 
